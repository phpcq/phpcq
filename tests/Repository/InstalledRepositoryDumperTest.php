...
final class InstalledRepositoryDumperTest extends TestCase
{
    ...
    public function testLockFileDump(): void
    {
        ...
        $installedPlugin->method('getFilePath')->willReturn(self::$tempdir . '/plugins/plugin-code.php');
        $installedPlugin->method('getSignaturePath')->willReturn(self::$tempdir . '/plugins/plugin-code.php.asc');
        ...
        $installedPlugin->method('getFilePath')->willReturn(self::$tempdir . '/plugins/plugin-code2.php');
        $installedPlugin->method('getSignaturePath')->willReturn(self::$tempdir . '/plugins/plugin-code2.php.asc');
            ...
            [
                'plugins' => [
                    'plugin-name' => [
                        ...
                        'version'      => '2.0.0',
                        'type'         => 'php-file',
                        'url'          => 'plugins/plugin-code.php',
                        'signature'    => 'plugins/plugin-code.php.asc',
                        'requirements' => [
                            'php' => [
                                'php' => '^7.3',
                            ],
                    ...
                    'plugin-name2' => [
                        ...
                        'version'      => '3.0.0',
                        'type'         => 'php-file',
                        'url'          => 'plugins/plugin-code2.php',
                        'signature'    => 'plugins/plugin-code2.php.asc',
                        'requirements' => [
                            'php' => [
                                'php' => '^7.3',
                            ],
