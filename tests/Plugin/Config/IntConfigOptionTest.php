...
final class IntConfigOptionTest extends TestCase
{
    ...
    {
        $option = new IntConfigOption('param', 'Param description', 1);
        $this->assertInstanceOf(ConfigOptionInterface::class, $option);
    }

    public function testInformation(): void
    {
        $option = new IntConfigOption('param', 'Param description', 2);
        ...
        $option = new IntConfigOption('param2', 'Param2 description', 1);
