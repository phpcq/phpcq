...
class PluginRegistryTest extends TestCase
{
    public function testLoadFromInstalledRepository(): void
    {
        ...
        $repository->addPluginVersion($tool1 = $this->getMockForAbstractClass(ToolInformationInterface::class));
        $repository->addPluginVersion($tool2 = $this->getMockForAbstractClass(ToolInformationInterface::class));
